# Local Ganache Accounts (Deterministic)

Command used: `ganache --port 8545 --networkId 5777 --deterministic`

## Available Accounts (1000 ETH each)
(0) `0x90F8bf6A479f320ead074411a4B0e7944Ea8c9C1` (Deployer / Admin)
...
## How to use with MetaMask
1. Open MetaMask → Add Network:
   - Network Name: `Ganache Local`
   - RPC URL: `http://127.0.0.1:8545`
   - Chain ID: `1337` (or `5777`)
   - Currency: `ETH`
2. Import Account → Paste **Private Key (0)** for company/admin testing
3. Import Account → Paste **Private Key (1)** for voter testing
